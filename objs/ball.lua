...
function ball:initialize(type,x,y,size,color)
	...
	self.pic = love.graphics.newImage("texture/smile.png")
end

function ball:ctrl()
	if  love.keyboard.isDown("a") then
		self.body.centerBody:applyTorque(-999999)
		self.body.centerBody:applyForce(-9999,0)
	end
	...
	if  love.keyboard.isDown("w") then
		self.body.centerBody:applyForce(0,-99999)
	end	
end
